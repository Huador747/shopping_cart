...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2025 at 09:30 AM
...
(34, 'SC SHAD', 13, 'สี LASER PINK PURPLE\r\nความยาว 5 เซนติเมตร\r\nน้ำหนักเหยื่อ 17 กรัม\r\nขนาดตัวเบ็ด เบอร์ 12', 'Daiwa SC Shad มีรูปลักษณ์ที่สมจริงสุดๆ พร้อมด้วยตาที่สั่นและสีสันที่ดูเหมือนของจริงที่จะดึงดูดปลาจากระยะไกล SC Shad มีความยาว 2 นิ้ว และมีสีสันที่หลากหลาย  ที่ดูเป็นธรรมชาติ ซึ่งปลาหลายชนิดไม่สามารถต้านทานได้', '99078104120250227_042738.png', 300, '10', 'ชิ้น', 1, '2025-02-26 21:27:58'),
...
--
ALTER TABLE `tbl_product`
  MODIFY `p_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
