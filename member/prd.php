                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="product-thumbnails">
                                <img src="<?php echo $img_path; ?>" class="thumbnail" onclick="document.getElementById('myImg').src=this.src">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="bundle-check">
                                            ...
                                            <div>฿<?php echo number_format($row["p_price"] * 1.2, 2); ?> ฿<?php echo number_format($row["p_price"] * 0.9, 2); ?> USD</div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel">
                                    <div class="p-3">
                                        ...
                                        <div class="rating mb-3">
                                            ...
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star-half-alt"></i>
                                            <?php echo $rating; ?> overall rating based on <?php echo $review_count; ?> reviews
                                        </div>
                                    </div>
                                </div>
                            </div>
...
.discount-section, .subtotal-section {
    display: flex;
    justify-content: space-between;
    margin-bottom: 15px;
}
